          ...
          <Popover>
            {({ open }) => (
              <>
                ...
                group inline-flex items-center active:outline-none`}
                >
                  <Image
                    loading="lazy"
                    src="/cart-icon.svg"
                    ...
                    sizes="100vw"
                    style={{ width: "16px", height: "16px" }}
                    className="mt-1 mr-1 aspect-square object-contain object-center w-4 overflow-hidden shrink-0 max-w-full"
                  />
                  <span className="mt-1 text-sky-500 text-center text-xs leading-4 tracking-wide">
                    {cartItemCount}
                  </span>
                </Popover.Button>
